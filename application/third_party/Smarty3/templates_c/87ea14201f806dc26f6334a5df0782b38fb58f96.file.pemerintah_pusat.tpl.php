<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-05-23 14:07:03
         compiled from "application\views\administrator\user_pemerintah\pemerintah_pusat.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11003555eab3e392fa5-64816118%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '87ea14201f806dc26f6334a5df0782b38fb58f96' => 
    array (
      0 => 'application\\views\\administrator\\user_pemerintah\\pemerintah_pusat.tpl',
      1 => 1432268689,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '11003555eab3e392fa5-64816118',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_555eab3e3961b1_16155525',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_555eab3e3961b1_16155525')) {function content_555eab3e3961b1_16155525($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8" />
...
<body>
    ...
    <div class="col-lg-12">
        ...
        <div class="clearfix">
            <div class="btn-group">
                <a href="<?php echo site_url('administrator/pemerintahpusat/insert');?>
" class="btn btn-primary">
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['PemerintahPusat']->result(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                            <tr>
                                ...
                                <td><b><?php echo $_smarty_tpl->tpl_vars['pusat']->value->NamaPemerintah;?>
</b></td>
                                <td><?php echo $_smarty_tpl->tpl_vars['pusat']->value->Username;?>
</td>
                                <td><?php echo $_smarty_tpl->tpl_vars['pusat']->value->NamaPusat;?>
</td>
                                <td>
                                    <div class="btn-group">
                                        <a href="<?php echo site_url('administrator/pemerintahpusat/edit');?>
/<?php echo $_smarty_tpl->tpl_vars['pusat']->value->ID;?>
" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit" data-original-title="" title=""></i></a>
                                        <a class="btn btn-danger" data-toggle="modal" data-target="#delete<?php echo $_smarty_tpl->tpl_vars['pusat']->value->ID;?>
" title="Delete"><i class="fa fa-trash-o" data-original-title="" title=""></i></a>
                                    </div>
                                    <div class="modal fade bs-example-modal-sm" id ="delete<?php echo $_smarty_tpl->tpl_vars['pusat']->value->ID;?>
">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    Akun <?php echo $_smarty_tpl->tpl_vars['pusat']->value->NamaPemerintah;?>

                                                    <input type="hidden" name="UserID" value="<?php echo $_smarty_tpl->tpl_vars['pusat']->value->UserID;?>
">
                                                </div>
                                                <div class="modal-footer">
                                                    <a href='<?php echo site_url('administrator/pemerintahpusat/delete');?>
/<?php echo $_smarty_tpl->tpl_vars['pusat']->value->ID;?>
?user=<?php echo $_smarty_tpl->tpl_vars['pusat']->value->UserID;?>
