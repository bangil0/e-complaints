        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="text-center" id="author">
                    {if $row->Logo eq ""}
                        <img src="{base_url()}assets/img/avatar-mini.jpg" class="img-center img-thumbnail img-responsive" width="150">
                    {else}
                        <img src="{base_url()}assets/img/{$row->Logo}" class="img-center img-thumbnail img-responsive" width="150">
                    {/if}
                    <h3>{$row->Nama}</h3>
        ...
        <section class="panel">
            <div class="panel-body">
                <a href="#" class="task-thumb">
                    ...
                    {else}
                        <img src="{base_url()}assets/img/{$row->Logo}" class="img-center img-thumbnail img-responsive">
                    {/if}
