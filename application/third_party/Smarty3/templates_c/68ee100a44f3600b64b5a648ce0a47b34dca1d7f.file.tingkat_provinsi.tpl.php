<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-05-23 14:08:35
         compiled from "application\views\administrator\tingkat_pemerintah\tingkat_provinsi.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10811555edb7be44801-71289294%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '68ee100a44f3600b64b5a648ce0a47b34dca1d7f' => 
    array (
      0 => 'application\\views\\administrator\\tingkat_pemerintah\\tingkat_provinsi.tpl',
      1 => 1432279963,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '10811555edb7be44801-71289294',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_555edb7c0f5f68_53035766',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_555edb7c0f5f68_53035766')) {function content_555edb7c0f5f68_53035766($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8" />
...
<body>
    ...
    <ol class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li class="active">Tingkat Provinsi</li>
    </ol>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel">
            <div class="panel-body">
                <?php echo form_open_multipart('administrator/tingkatprovinsi/insert','class="form-horizontal"');?>
...
?>
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['TingkatProvinsi']->result(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                            <tr>
                                ...
                                <td><b><?php echo $_smarty_tpl->tpl_vars['provinsi']->value->Nama;?>
</b></td>
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-danger" data-toggle="modal" data-target="#delete<?php echo $_smarty_tpl->tpl_vars['provinsi']->value->ID;?>
" title="Delete"><i class="fa fa-trash-o" data-original-title="" title=""></i></a>
                                    </div>
                                    <div class="modal fade bs-example-modal-sm" id ="delete<?php echo $_smarty_tpl->tpl_vars['provinsi']->value->ID;?>
">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    Akun <?php echo $_smarty_tpl->tpl_vars['provinsi']->value->Nama;?>

                                                    <input type="hidden" name="UserID" value="<?php echo $_smarty_tpl->tpl_vars['provinsi']->value->ID;?>
">
                                                </div>
                                                <div class="modal-footer">
                                                    <a href='<?php echo site_url('administrator/tingkatprovinsi/delete');?>
/<?php echo $_smarty_tpl->tpl_vars['provinsi']->value->ID;?>
