    ...
    <div class="col-lg-12">
        ...
        <div class="panel">
            <div class="panel-body">
                {form_open_multipart('administrator/tingkatprovinsi/insert', 'class="form-horizontal"')}
        ...
        <section class="panel">
            <div class="panel-body">
                <table class="table table-advance table-responsive" id="example3">
                    ...
                    <tbody>
                        {foreach $data.TingkatProvinsi->result() as $provinsi}
                            <tr>
                                <td>{$provinsi->ID}</td>
                                <td><b>{$provinsi->Nama}</b></td>
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-danger" data-toggle="modal" data-target="#delete{$provinsi->ID}" title="Delete"><i class="fa fa-trash-o" data-original-title="" title=""></i></a>
                                    </div>
                                    <div class="modal fade bs-example-modal-sm" id ="delete{$provinsi->ID}">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    Akun {$provinsi->Nama}
                                                    <input type="hidden" name="UserID" value="{$provinsi->ID}">
                                                </div>
                                                <div class="modal-footer">
                                                    <a href='{site_url('administrator/tingkatprovinsi/delete')}/{$provinsi->ID}' type="button" class="btn btn-primary">Ya</a>
