<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-04-12 22:38:40
         compiled from "application/views/administrator/menu_layanan/layanan_internet.tpl" */ ?>
<?php /*%%SmartyHeaderCode:679199795551ec1e4cb4f49-16254807%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '41c8686b7bbee5bf61576cb2481b1a7a3c83d844' => 
    array (
      0 => 'application/views/administrator/menu_layanan/layanan_internet.tpl',
      1 => 1428846078,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '679199795551ec1e4cb4f49-16254807',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_551ec1e4dd8c87_07152230',
  'variables' => 
  array (
    'data' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_551ec1e4dd8c87_07152230')) {function content_551ec1e4dd8c87_07152230($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
<body class="skin-blue">
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Data Internet</h1>
                <h4>Informasi Data Internet</h4>
            </div>
        </div>
        <!-- END Page Title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-table"></i> Data Internet</h3>
                    </div>
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['data_internet']->result(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <a class="btn btn-default" title="" id="pembimbing" data-toggle="modal" data-target="#user" data-original-title="Edit selected" data-nama_pembimbing="<?php echo $_smarty_tpl->tpl_vars['row']->value->nama;?>
" data-nama_pemohon="<?php echo $_smarty_tpl->tpl_vars['row']->value->nama_pemohon;?>
"><i class="fa fa-edit"></i> Lanjut</a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
...
<!-- Addons Scripts -->
 ...
 type="text/javascript">
        $(document).on("click", "#pembimbing", function () {
            var nama_pembimbing = $(this).data('nama_pembimbing');
            var nama_pemohon = $(this).data('nama_pemohon');
            $(".modal-body #nama_pembimbing").val(nama_pembimbing);
            $(".modal-body #nama_pemohon").val(nama_pemohon);
        });
    <?php echo '</script'; ?>
>
