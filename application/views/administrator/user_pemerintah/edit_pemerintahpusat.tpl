...
{block name="breadcrumb"}
    <ol class="breadcrumb">
        ...
        <li class="active">Edit Pemerintah Pusat</li>
    </ol>
{/block}
...
{block name="content"}
    <div class="col-lg-12">
        <h2 class="page-header">
            Edit Akun Pemerintah Pusat
        </h2>
        <!-- start:state overview -->
        <section class="panel">
            <div class="panel-body">
                {form_open_multipart('administrator/pemerintahpusat/edit/'|cat:$data.id, 'class="form-horizontal"')}
                ...
                <div class="form-group">
                    <label class="col-sm-3 col-lg-2 control-label">Pemerintah Pusat</label>
                    <div class="col-sm-9 col-lg-10 controls">
