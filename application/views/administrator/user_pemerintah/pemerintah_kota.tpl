...
{block name="content"}
    <div class="col-lg-12">
        ...
        <div class="clearfix">
            <div class="btn-group">
                <a href="{site_url('administrator/pemerintahkota/insert')}" class="btn btn-primary">
        ...
        <section class="panel">
            <div class="panel-body">
                <table class="table table-advance table-responsive" id="example3">
                    ...
                    <tbody>
                        {foreach $data.PemerintahKota->result() as $kota}
                            <tr>
                                <td>{$kota->ID}</td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{site_url('administrator/pemerintahkota/edit')}/{$kota->ID}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit" data-original-title="" title=""></i></a>
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    {$kota->ID}{$kota->NamaPemerintah}
                                                    <input type="text" name="UserID" value="{$kota->UserID}">
                                                </div>
                                                <div class="modal-footer">
                                                    <a href='{site_url('administrator/pemerintahkota/delete')}/{$kota->ID}?user={$kota->UserID}' type="button" class="btn btn-primary">Ya</a>
