<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-04-12 20:51:29
         compiled from "application/views/administrator/menu_pegawai/data_administrator.tpl" */ ?>
<?php /*%%SmartyHeaderCode:177028156552a7861d83364-78415912%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a50cd2038b4aafeabcca2a5057a67b7ddbf52b54' => 
    array (
      0 => 'application/views/administrator/menu_pegawai/data_administrator.tpl',
      1 => 1428846078,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '177028156552a7861d83364-78415912',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_552a7861ee14d1_50008726',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_552a7861ee14d1_50008726')) {function content_552a7861ee14d1_50008726($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
<body class="skin-blue">
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Data Administrator</h1>
                <h4>Informasi Data Administrator</h4>
            </div>
        </div>
        <!-- END Page Title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-table"></i> Data Administrator</h3>
                    </div>
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['data_administrator']->result(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
