<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-03-02 07:18:15
         compiled from "application\views\administrator\pengujian.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3118754f3ac4783ba59-32003164%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6ed735ce1b6126b0f21eeedee74fbb6a7d974f11' => 
    array (
      0 => 'application\\views\\administrator\\pengujian.tpl',
      1 => 1425255232,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '3118754f3ac4783ba59-32003164',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54f3ac47984946_98311643',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54f3ac47984946_98311643')) {function content_54f3ac47984946_98311643($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
<body class="skin-blue">
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Pengujian</h1>
                <h4>Informasi Pengujian</h4>
            </div>
        </div>
        <!-- END Page Title -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-table"></i> Data Pengujian</h3>
                    </div>
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['data_pengujian']->result(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                                        <tr>
                                            ...
                                            <td><?php echo $_smarty_tpl->tpl_vars['row']->value->nama_pengujian;?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['row']->value->nama_alat;?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['row']->value->harga;?>
</td>
...
<!-- Modal -->
    ...
    <!-- Large modal -->
    <div class="modal fade bs-example-modal-sm" id ="tambah">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="controls">
                            <input type="text" class="form-control" placeholder="Ketik Nama Kategori Berita">
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade bs-example-modal-sm" id ="edit">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Ubah Kategori Berita</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="controls">
    ...
    <div class="modal fade bs-example-modal-sm" id ="detail">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
