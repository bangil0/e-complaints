<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-04-12 22:38:44
         compiled from "application/views/administrator/menu_layanan/name_tag.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1199462557551ed13cea2ff4-65443679%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b65ec7b45df57bc3502516ca3f432917cfdb52c7' => 
    array (
      0 => 'application/views/administrator/menu_layanan/name_tag.tpl',
      1 => 1428846078,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1199462557551ed13cea2ff4-65443679',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_551ed13d06b6a5_30271110',
  'variables' => 
  array (
    'data' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_551ed13d06b6a5_30271110')) {function content_551ed13d06b6a5_30271110($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
<body class="skin-blue">
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Data Nametag</h1>
                <h4>Informasi Data Nametag</h4>
            </div>
        </div>
        <!-- END Page Title -->
        ...
        <div id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Data Nametag</li>
            </ul>
        </div>
        <!-- END Breadcrumb -->
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['data_nametag']->result(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
