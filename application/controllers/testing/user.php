...
class User extends CI_Controller{
	...
	{
		parent::__construct();
		$this->load->model('testing/user_model');
	}
	public function index()
	{
		if($this->session->userdata('user_name')!="")
		{
			...
			$data['title']= 'Home';
			$this->load->view('testing/header_view',$data);
			$this->load->view("testing/registration_view.php", $data);
			$this->load->view('testing/footer_view',$data);
		}
	}
	function welcome()
	{
		$data['title']= 'Welcome';
		$this->load->view('testing/header_view',$data);
		$this->load->view('testing/welcome_view.php', $data);
		$this->load->view('testing/footer_view',$data);
	}
	...
	function thank()
	{
		$data['title']= 'Thank';
		$this->load->view('testing/header_view',$data);
		$this->load->view('testing/thank_view.php', $data);
		$this->load->view('testing/footer_view',$data);
	}
