<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-03-22 19:30:54
         compiled from "application\views\administrator\menu_pegawai\data_operator.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17831550eb453d54d18-21006323%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '920b28431e1addf30a7b7fd2844f49e574a9a1f0' => 
    array (
      0 => 'application\\views\\administrator\\menu_pegawai\\data_operator.tpl',
      1 => 1427027373,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '17831550eb453d54d18-21006323',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_550eb453ed9d66_09397457',
  'variables' => 
  array (
    'data' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_550eb453ed9d66_09397457')) {function content_550eb453ed9d66_09397457($_smarty_tpl) {?><!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
...
<body class="skin-blue">
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Data Operator</h1>
                <h4>Informasi Data Operator</h4>
            </div>
        </div>
        <!-- END Page Title -->
        ...
        <div id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Data Operator</li>
            </ul>
        </div>
        <!-- END Breadcrumb -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-table"></i> Data Operator</h3>
                    </div>
 ...
 $_from = $_smarty_tpl->tpl_vars['data']->value['data_operator']->result(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
    ...
    <div class="modal fade bs-example-modal-lg" id ="detail">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Detail Data Operator</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="controls">
