<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-06-06 04:54:20
         compiled from "application\views\pemerintah\history_tanggapan.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9525557167cf3beb12-38537732%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a4775adf5dacc6aba56a6bc231fca166bf18166c' => 
    array (
      0 => 'application\\views\\pemerintah\\history_tanggapan.tpl',
      1 => 1433541257,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '9525557167cf3beb12-38537732',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_557167cf633d83_10533893',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_557167cf633d83_10533893')) {function content_557167cf633d83_10533893($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8" />
    ...
    <div class="col-lg-8">
        ...
        <div id="myTabContent" class="tab-content">
            <div class="tab-pane fade in active" id="proses">
                <?php if (count($_smarty_tpl->tpl_vars['data']->value['keluhan_proses']->result())>0) {?>
                    <?php  $_smarty_tpl->tpl_vars['belum'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['belum']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['data']->value['keluhan_proses']->result(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
&nbsp;&nbsp;&nbsp;<span class="fa fa-ambulance"></span> <?php echo $_smarty_tpl->tpl_vars['belum']->value->email;?>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="well well-primary">
                                        <h4><?php echo $_smarty_tpl->tpl_vars['belum']->value->IsiTanggapan;?>
</h4>
                                    </div>
                                    <a href="<?php echo site_url('pemerintah/ubah_status_keluhan');?>
/<?php echo $_smarty_tpl->tpl_vars['belum']->value->KeluhanID;?>
" class="btn btn-success btn-drop" >
                                        Ubah Status Selesai
                                    </a>
                                </div>
                            </div>
            ...
            <div class="tab-pane fade" id="selesai">
                <?php if ($_smarty_tpl->tpl_vars['data']->value['keluhan_selesai']->result()>0) {?>
                    <?php  $_smarty_tpl->tpl_vars['belum'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['belum']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['data']->value['keluhan_selesai']->result(); if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['belum']->key => $_smarty_tpl->tpl_vars['belum']->value) {
$_smarty_tpl->tpl_vars['belum']->_loop = true;
?>
                        <div class="panel panel-primary">
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate("pemerintah/widget_right.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '9525557167cf3beb12-38537732');
content_55721a8ce21b14_05611251($_smarty_tpl);
...
<?php if ($_valid && !is_callable('content_55721a8ce21b14_05611251')) {function content_55721a8ce21b14_05611251($_smarty_tpl) {?><?php  $_smarty_tpl->tpl_vars['row'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['row']->_loop = false;
